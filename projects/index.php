            ...
            <div class="col-md-6 mb-4">
                <a href="#" class="card hover p-0">
                    ...
                    <div class="p-4 pb-5 pt-3 pb-2">
                        ...
                        <div class="subtitle text-muted mb-2">Task management platform
                        </div>
                        <img class="me-2" src="https://img.icons8.com/ios/20/ffffff/laravel.png" data-toggle="tooltip" data-placement="top" title="Laravel">
                        <img class="me-2" src="https://img.icons8.com/ios-glyphs/20/ffffff/css3.png" data-toggle="tooltip" data-placement="top" title="CSS">
                        <img class="me-2" src="https://img.icons8.com/ios-filled/20/ffffff/php-logo.png" data-toggle="tooltip" data-placement="top" title="PHP">
                        <img class="me-2" src="https://img.icons8.com/material-outlined/20/ffffff/mysql-logo.png" data-toggle="tooltip" data-placement="top" title="MySQL">
                    </div>
                </a>
            </div>
            ...
            <div class="col-md-6 mb-4">
                <a href="#" class="card hover p-0">
                    ...
                    <div class="p-4 pb-5 pt-3 pb-2">
                        ...
                        <img class="me-2" src="https://img.icons8.com/external-tal-revivo-regular-tal-revivo/20/ffffff/external-json-javascript-object-notation-is-a-lightweight-data-interchange-format-logo-regular-tal-revivo.png" data-toggle="tooltip" data-placement="top" title="JSON">
                        ...
                        <span class="small text-white">+ 5 more</span>
                    </div>
                </a>
            </div>
            ...
            <div class="col-md-6 mb-4">
                <a href="#" class="card hover p-0">
                    ...
                    <div class="p-4 pb-5 pt-3 pb-2">
                        ...
                        <img class="me-2" src="https://img.icons8.com/ios-filled/20/ffffff/jquery.png" data-toggle="tooltip" data-placement="top" title="jQuery">
                        <img class="me-2" src="https://img.icons8.com/ios-filled/20/ffffff/php-logo.png" data-toggle="tooltip" data-placement="top" title="PHP">
                        <img class="me-2" src="https://img.icons8.com/ios-filled/20/ffffff/javascript.png" data-toggle="tooltip" data-placement="top" title="JavaScript">
                    </div>
                </a>
            </div>
            ...
            <div class="col-md-6">
                <a href="#" class="card hover p-0">
                    ...
                    <div class="p-4 pb-4 pt-3 pb-2">
                        ...
                        <img class="me-2" src="https://img.icons8.com/external-tal-revivo-bold-tal-revivo/20/ffffff/external-firebase-a-googles-mobile-platform-that-helps-you-quickly-develop-high-quality-apps-logo-bold-tal-revivo.png" data-toggle="tooltip" data-placement="top" title="Firebase">
                        <img class="me-2" src="https://img.icons8.com/windows/20/ffffff/vuejs.png" data-toggle="tooltip" data-placement="top" title="VueJS">
                        <img class="me-2" src="https://img.icons8.com/ios-glyphs/20/ffffff/spotify.png" data-toggle="tooltip" data-placement="top" title="Spotify API">
                        <img class="me-2" src="https://img.icons8.com/external-tal-revivo-bold-tal-revivo/20/ffffff/external-bootstrap-a-free-and-open-source-css-framework-logo-bold-tal-revivo.png" data-toggle="tooltip" data-placement="top" title="Bootstrap">
                    </div>
                </a>
            </div>
            ...
            <div class="col-md-6">
                <a href="#" class="card hover p-0">
                    ...
                    <div class="p-4 pb-4 pt-3 pb-2">
                        ...
                        <div class="subtitle text-muted mb-2">Mock website redesign</div>
                        <img class="me-2" src="https://img.icons8.com/material/20/ffffff/adobe-xd.png" data-toggle="tooltip" data-placement="top" title="Adobe XD">
                    </div>
                </a>
            </div>
